...
local ConfigFileName = "TrickyHub_Config.json"
...
coordESPFolder.Name = "TrickyHub_CoordESP"
...
local DISCORD_TEXT = "discord.gg/trickyhub"
...
subtitleLabel.Text = "discord.gg/trickyhub"
